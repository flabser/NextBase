...
/*        if (value.length() > 2046) {
    ...
    public ArrayList<_Document> getDescendants() throws DocumentAccessException, DocumentException, _Exception {
        try {
            ...
            Set<String> userGroups = new HashSet<String>();
            if (currentUserID != null) {
                if (currentUserID.equalsIgnoreCase("[" + Const.sysUser + "]") || currentUserID.equalsIgnoreCase("server") || currentUserID.equalsIgnoreCase(Const.sysUser) || currentUserID.equalsIgnoreCase("admin")) {
