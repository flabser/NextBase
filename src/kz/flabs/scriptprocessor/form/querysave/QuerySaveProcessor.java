...
public class QuerySaveProcessor implements IProcessInitiator {
	...
	public QuerySaveResult doScript() {
		...
		try {
			...
			compilationFailedException.printStackTrace(); // To change body of
			                                              // catch statement use
			                                              // File | Settings |
			                                              // File Templates.
		}
	...
	public static String normalizeScript(String script) {
		String beforeScript = "import kz.flabs.dataengine.Const;" + "import kz.flabs.scriptprocessor.form.querysave.*;"
		        + ScriptProcessorUtil.packageList + "class Foo extends AbstractQuerySaveScript{";
		String afterScript = "}";
