...
public class QueryRule extends Rule implements IQueryRule,Const {	
	...
	public QueryRule(AppEnv env, File ruleFile) throws QueryFormulaParserException, RuleException{
		...
		query = new RuleValue(XMLUtil.getTextContent(doc,"/rule/query"), 
				XMLUtil.getTextContent(doc,"/rule/query/@source",true,"STATIC", false),
	...
	public String getRuleAsXML(String app){
		String xmlText = "<rule id=\"" + id + "\" isvalid=\"" + isValid + "\" app=\"" + app + "\" ison=\"" + isOn + "\">" +			
				...
				"<doctype>" + queryType + "</doctype>" +
				"<hits>" + hits + "</hits>" +	
				"<turbomode>" + turboMode + "</turbomode>" +	
				"<rununderuser>" + runUnderUser.getValue() + "</rununderuser>" +
				"<cachemode>" + cacheMode + "</cachemode>" +	
				"<query>" + query.toXML() + "</query>" +
				"<queryformulablocks>" + queryFormulaBlocks.toXML() + "</queryformulablocks>" + 
				"<groupby>" + groupBy + "</groupby>" +
				"<groupbypublicationformat>" + groupByPublicationFormat + "</groupbypublicationformat>" +
				"<sortby>" + sortBy + "</sortby>" +
				"<sortbypublicationformat>" + sortByPublicationFormat + "</sortbypublicationformat>" +
	...
	public static void main(String[] args){
		try {
			...
			File ruleFile = new File("C:"+File.separator+"workspace"+File.separator+"NextBase"+File.separator+"rule"+File.separator+"Avanti"+File.separator+"Query"+File.separator+"corresp.xml");
