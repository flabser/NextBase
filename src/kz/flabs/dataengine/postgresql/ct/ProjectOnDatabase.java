...
public class ProjectOnDatabase extends kz.flabs.dataengine.h2.ProjectOnDatabase implements IProjects, Const {
    ...
    public int insertProject(Project doc, User user)
        ...
        try {
            conn.setAutoCommit(false);
            org.postgresql.jdbc4.Jdbc4Connection dconn = (org.postgresql.jdbc4.Jdbc4Connection) conn;
            LargeObjectManager lobj = dconn.getLargeObjectAPI();
            ...
            statProject.setTimestamp(8, new Timestamp(new Date().getTime()));
