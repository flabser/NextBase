...
public class Database extends DatabaseCore implements IDatabase, Const {
    ...
    public void resetTopic(int parentDocID, int parentDocType, User user) throws DatabasePoolException, InstantiationException, IllegalAccessException, ClassNotFoundException, ComplexObjectException {
        Connection conn = dbPool.getConnection();
        String tableName = DatabaseUtil.getMainTableName(parentDocType);
    ...
    public void deleteDocument(String docID, boolean completely, User user) throws DocumentException, DocumentAccessException, SQLException, DatabasePoolException, InstantiationException, IllegalAccessException, ClassNotFoundException, ComplexObjectException {
        ...
        try {
            ...
            if (docType != DOCTYPE_GLOSSARY && docType != DOCTYPE_GROUP) {
                ...
                if (this.getGlossaries().hasResponse(conn, doc.getDocID(), doc.docType, user.getAllUserGroups(), user.getUserID()) || this.getGlossaries().inUse(conn, doc.getDocID(), doc.docType)) {
