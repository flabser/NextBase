...
class QueryOpen extends _FormQueryOpen{
	...
	public void doQueryOpen(_Session session, _WebFormData webFormData, String lang) {
		publishValue("title",getLocalizedWord("Выпуск продукции", lang))
	...
	public void doQueryOpen(_Session session, _Document doc, _WebFormData webFormData, String lang) {
		publishValue("title",getLocalizedWord("Выпуск продукции", lang) + ":" + doc.getViewText())
		publishEmployer("author",doc.getAuthorID())
		publishGlossaryValue("product", doc.getValueNumber("product"));
		publishValue("count", doc.getValueString("count"))
		publishValue("date", doc.getValueString("date"))
