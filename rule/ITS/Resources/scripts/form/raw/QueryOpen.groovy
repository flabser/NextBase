...
class QueryOpen extends _FormQueryOpen{
	...
	public void doQueryOpen(_Session session, _WebFormData webFormData, String lang) {
		publishValue("title",getLocalizedWord("Сырье/Деталь", lang))
	...
	public void doQueryOpen(_Session session, _Document doc, _WebFormData webFormData, String lang) {
		...
		publishValue("title",getLocalizedWord("Сырье/Деталь", lang) + ":" + glos.getViewText())
		publishEmployer("author",glos.getAuthorID())
		publishValue("name",glos.getName())
		publishValue("norm", glos.getValueString("norm"))
		publishGlossaryValue("ednorm", doc.getValueGlossary("ednorm"))
		publishGlossaryValue("supplier", doc.getValueGlossary("supplier"))
