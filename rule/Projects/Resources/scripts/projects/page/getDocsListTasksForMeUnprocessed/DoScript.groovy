package projects.page.getDocsListTasksForMeUnprocessed
...
class DoScript extends _DoScript {
	...
	//	println(formData)
		...
		def formula = "form='demand' and viewtext4 = '1' and has_response = 0 and executer ~ '" +  session.getCurrentUserID() + "'";
