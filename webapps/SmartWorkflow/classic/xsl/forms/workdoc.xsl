...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/request">
		<html>
			<head>
				<title>
					<xsl:value-of select="document/captions/memo/@caption"/> - Workflow документооборот 
				</title>
					...
					<div class="formwrapper">
						...
						<div class="button_panel">
							<span style="width:82% ; vertical-align:12px; float:left">
								...
								<xsl:call-template name="newoutgoing"/>
								<!-- кнопка "ознакомить" -->		
								...
								<div class="ui-tabs-panel" id="tabs-1">
									...
									<table width="100%" border="0">
										...
										<tr>
											...
											<td>
												<div>						
													<textarea name="briefcontent" style="width:748px;"  rows="3" class="textarea_noteditable" onfocus="javascript:$(this).blur()">
