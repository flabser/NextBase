...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/request">
		<html>
			<head>
				<title>
					<xsl:value-of select="document/captions/title/@caption" /> - Workflow документооборот
				</title>
						...
						<div class="button_panel">
							<span style="vertical-align:12px; float:left">
								...
								<xsl:if test="document/actionbar/action[@id ='save_as_draft']/@mode = 'ON'">
									<button title="{document/actionbar/action[@id ='save_as_draft']/@hint}" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" autocomplete="off" id="btnsavedraft">
								...
								<xsl:if
									test="document/actions/action [.='STOP_DOCUMENT']/@enable = 'true'">
									<button title="{document/actions/action [.='STOP_DOCUMENT']/@hint}" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" autocomplete="off" id="btnstopdoc" style="margin-left:5px">
										<xsl:attribute name="onclick">javascript:stopdocument('<xsl:value-of select="document/@docid" />','<xsl:value-of select="history/entry[@type = 'page'][last()]" />')</xsl:attribute>
										<span>
											<img
												src="/SharedResources/img/classic/icons/page_white_delete.png"
												class="button_img" />
											<font style="font-size:12px; vertical-align:top">
								...
								<xsl:if test="document/actionbar/action[@id ='send']/@mode = 'ON'">
									<button title="{document/actionbar/action[@id ='send']/@hint}" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" autocomplete="off" id="btnsendsign" style="margin-left:5px">
										<xsl:attribute name="onclick">javascript:saveAndSend('<xsl:value-of select="history/entry[@type = 'page'][last()]"/>')</xsl:attribute>
										<span>
											<img src="/SharedResources/img/classic/icons/page_white_edit.png"
												class="button_img" />
											<font style="font-size:12px; vertical-align:top">
												<xsl:value-of
													select="document/actionbar/action[@id ='send']/@caption" />
											</font>
										</span>
									</button>
								</xsl:if>
								...
								<xsl:if test="document/actionbar/action[@id ='to_coordinate']/@mode = 'ON'">
									<button title="{document/actionbar/action[@id ='to_coordinate']/@hint}" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" autocomplete="off" id="btntocoordinate" style="margin-left:5px">
										<xsl:attribute name="onclick">javascript:saveAndCoord('<xsl:value-of select="history/entry[@type = 'page'][last()]"/>')</xsl:attribute>
										<span>
											<img src="/SharedResources/img/classic/icons/page_white_go.png"
												class="button_img" />
											<font style="font-size:12px; vertical-align:top">
												<xsl:value-of
													select="document/actionbar/action[@id ='to_coordinate']/@caption" />
											</font>
										</span>
									</button>
								</xsl:if>
								...
								<xsl:if test="document/actionbar/action[@id ='sign_yes']/@mode = 'ON'">
									<button title="{document/actionbar/action[@id ='sign_yes']/@hint}" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" autocomplete="off" id="btnsign" style="margin-left:5px">
								...
								<xsl:if test="document/actionbar/action[@id ='sign_no']/@mode = 'ON'">
									<button title="{document/actionbar/action[@id ='sign_no']/@hint}" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" autocomplete="off" id="btnsignno" style="margin-left:5px">
										...
										<span>
											<img src="/SharedResources/img/classic/icons/cancel.png"
												class="button_img" />
											<font style="font-size:12px; vertical-align:top">
												<xsl:value-of
													select="document/actionbar/action[@id ='sign_no']/@caption" />
											</font>
										</span>
									</button>
								</xsl:if>
								...
								<xsl:if test="document/actionbar/action[@id ='coord_yes']/@mode = 'ON'">
									<button title="{document/actionbar/action[@id ='coord_yes']/@hint}" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" autocomplete="off" id="btncoordyes" style="margin-left:5px">
										...
										<span>
											...
											<font style="font-size:12px; vertical-align:top">
												<xsl:value-of
													select="document/actionbar/action[@id ='coord_yes']/@caption"/>
											</font>
										</span>
									</button>
								</xsl:if>
								...
								<xsl:if test="document/actionbar/action[@id ='coord_no']/@mode = 'ON'">
									<button title="{document/actionbar/action[@id ='coord_no']/@hint}" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" autocomplete="off" id="btncoordno" style="margin-left:5px">
										...
										<span>
											<img src="/SharedResources/img/classic/icons/delete.png"
												class="button_img" />
											<font style="font-size:12px; vertical-align:top">
												<xsl:value-of
													select="document/actionbar/action[@id ='coord_no']/@caption"/>
											</font>
										</span>
									</button>
								</xsl:if>
								...
								<div class="ui-tabs-panel" id="tabs-1">
									...
									<table width="100%" border="0">
										...
										<tr>
											<td class="fc">
												<font style="vertical-align:top">
													<xsl:value-of select="document/captions/recipients/@caption"/>:
												</font>
												<xsl:if test="$editmode = 'edit'">
													<a href="">
											...
											<td>
												<table id="recipienttbl" style="border-spacing:0px 3px;">
													...
													<xsl:if test="not(document/fields/recipient/employer[node()])">
														<tr>
															<td class="td_editable" style="width:600px;">
																<xsl:if test="$editmode != 'edit'">
																	<xsl:attribute name="class">td_noteditable</xsl:attribute>
												...
												<input type="hidden" id="recipientcaption" value="{document/captions/recipients/@caption}"/>
											</td>
										</tr>
										...
										<!-- поле "Тип конечного документа" -->
											<tr>
												<td class="fc" style="padding-top:5px">
													<xsl:value-of select="document/captions/finaldoctype/@caption"/> :
												</td>
												<td style="padding-top:5px">
													<xsl:variable name="finaldoctype" select="document/fields/finaldoctype/@attrval" />
													<select size="1" class="select_editable" name="finaldoctype" style="width:611px;">
														<xsl:if test="$editmode != 'edit'">
															...
															<option value="{document/fields/finaldoctype/@attrval}">
																<xsl:attribute name="selected">selected</xsl:attribute>
																<xsl:value-of select="document/fields/finaldoctype" />
															</option>
