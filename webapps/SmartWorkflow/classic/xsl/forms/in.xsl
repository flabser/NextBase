			...
			<head>
				<title>
					<xsl:if test="document/@status = 'new'">
						<xsl:value-of select="document/captions/new/@caption"/>&#xA0;<xsl:value-of select="lower-case($doctype)"/>&#xA0;- Workflow документооборот
					</xsl:if>
					<xsl:if test="document/@status != 'new'">
							...
							<form action="Provider" name="frm" method="post" id="frm" enctype="application/x-www-form-urlencoded">
								<div class="ui-tabs-panel" id="tabs-1">
									...
									<table width="100%" border="0">
										...
										<tr>
											<td class="fc" style="padding-top:5px">
												...
												<xsl:if test="$editmode = 'edit'">
													<a>
														<xsl:attribute name="href">javascript:dialogBoxStructure('corrcat','false','corr','frm', 'corresptbl');</xsl:attribute>
										...
										<tr>
											...
											<td style="padding-top:5px">
												<select size="1" name="lang" style="width:611px;" class="select_editable">
													<xsl:if test="$editmode != 'edit'">
														<xsl:attribute name="class">select_noteditable</xsl:attribute>
														<xsl:attribute name="disabled"/>
													</xsl:if>
									...
									<tr>
										...
										<td style="padding-top:5px">
											<input type="text" name="ctrldate" maxlength="10" class="readonly" style="width:80px; vertical-align:top" value="{substring(document/fields/ctrldate,1,10)}">
												<xsl:if test="$editmode = 'edit'">
