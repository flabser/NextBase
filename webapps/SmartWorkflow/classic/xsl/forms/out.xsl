									...
									<table width="100%" border="0">
										...
										<tr>
									    	...
									    	<td>
						                        ...
						                        <xsl:value-of select="document/fields/dvn/@caption"/>&#xA0;
						                       	<input type="text" class="td_noteditable" value="{document/fields/dvn}" readonly="readonly" onfocus="javascript: $(this).blur()" style="width:150px;">
						                       	</input>
						                   </td>   					
										</tr>
										<!-- Поле "Корреспондент" -->
										<tr>
											...
											<td>
												...
												<input type="hidden" id="corrcaption" value="{document/fields/corr/@caption}"/>
											</td>
										</tr>
										<!-- поле "Подписал" -->
										<tr>
											...
											<td>
												...
												<input type="hidden" id="signedbycaption"  value="{document/fields/signedby/@caption}"/>	
											</td>
										</tr>
