...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template name="saveKR">
		<xsl:if test="document/actionbar/action[@id='save_and_close']/@mode = 'ON'">
			<button title ="{document/actionbar/action[@id='save_and_close']/@hint}" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" id="btnsavedoc" style="margin-left:5px" autocomplete="off">
	...
	<xsl:template name="eds_sign">
		<xsl:if test="document/actionbar/action[@id='eds_sign']/@mode = 'ON'">
			<button title ="{document/actionbar/action[@id='eds_sign']/@hint}" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" id="btnsignedsdoc" style="margin-left:5px" autocomplete="off">
				...
				<span>
					...
					<font style="font-size:12px; vertical-align:top;"><xsl:value-of select="document/actionbar/action[@id='eds_sign']/@caption"/></font>
				</span>
			</button>
		</xsl:if>
	...
	<xsl:template name="filling_report">
		<xsl:if test="document/actionbar/action[@id='save_and_close']/@mode = 'ON'">
			<button title ="{document/actionbar/action[@id='save_and_close']/@hint}" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" style="margin-left:5px"  id="generatereport" autocomplete="off">
	...
	<xsl:template name="newkr">
		<xsl:if test="document/actionbar/action[@id='compose_task']/@mode = 'ON'">
			<button title ="{document/actionbar/action [@id='compose_task']//@hint}" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" id="btnnewkr" style="margin-left:5px" autocomplete="off">
	...
	<xsl:template name="resetcontrol">
		<xsl:if test="document/actionbar/action[@id='reset']/@mode = 'ON' and document/fields/control/allcontrol != 0">
			<button  title ="{document/actionbar/action[@id = 'reset']/@hint}" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" id="btnnewkr" style="margin-left:5px" autocomplete="off">
	...
	<xsl:template name="newdiscussion">
		<xsl:if test="document/actions/action [.='COMPOSE_DISCUSSION']/@enable = 'true'">
			<button  title ="{document/actionbar/action[@id = 'COMPOSE_DISCUSSION']/@hint}" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" style="margin-left:5px" autocomplete="off">
	...
	<xsl:template name="newki">
		<xsl:if test="document/actionbar/action[@id='compose_execution']/@mode = 'ON'">
			<button title ="{document/actionbar/action[@id = 'compose_execution']/@hint}" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" id="btnexecution" style="margin-left:5px" autocomplete="off">
	...
	<xsl:template name="newoutgoing">
		<xsl:if test="document/actions/action [.='COMPOSE_OUTGOING']/@enable = 'true'">
			<button title ="{document/actions/action [.='COMPOSE_OUTGOING']/@hint}" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" id="btnnewish" style="margin-left:5px" autocomplete="off">
				<xsl:attribute name="onclick">javascript:window.location.href="Provider?type=document&amp;id=outdocprj&amp;docid=&amp;parentdocid=<xsl:value-of select="document/@docid"/>&amp;parentdoctype=<xsl:value-of select="document/@doctype"/>"</xsl:attribute>
				<span>
					<img src="/SharedResources/img//classic/icons/page_green.png" class="button_img"/>
					<font style="font-size:12px; vertical-align:top"><xsl:value-of select="document/captions/projectout/@caption"/></font>		
				</span>
			</button>
		</xsl:if>
	</xsl:template>
	...
	<xsl:template name="get_document_accesslist">
		<xsl:if test="document/actionbar/action[@id ='get_document_accesslist']/@mode = 'ON'">
			<button style="margin-right:5px" title= "{document/actionbar/action[@id = 'get_document_accesslist']/@hint}" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" autocomplete="off">
				...
				<span>
					<img src="/SharedResources/img/classic/icons/page_white_key.png" class="button_img"/>
					<font style="font-size:12px; vertical-align:top"><xsl:value-of select="document/actionbar/action[@id = 'get_document_accesslist']/@caption"/></font>
				</span>
			</button>
		</xsl:if>
	</xsl:template>
	...
	<xsl:template name="acquaint">
		<xsl:if test="document/actions/action [.='GRANT_ACCESS']/@enable = 'true'">
			<button title ="{document/actions/action [.='GRANT_ACCESS']/@hint}" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" id="btngrantaccess" style="margin-left:5px" autocomplete="off">
	...
	<xsl:template name="remind">
		<xsl:if test="document/actions/action [.='NOTIFY_EXECUTERS']/@enable = 'true'">
			<button title= "{document/actions/action [.='NOTIFY_EXECUTERS']/@hint}" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" id="btnremind" style="margin-left:5px" autocomplete="off">
