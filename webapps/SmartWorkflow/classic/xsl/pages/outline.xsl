				...
				<div id="footer">
					...
					<div style="padding:5px 20px 0px 10px; font-color: #444444; width:300px; float:right">
						<div id="langview" style=" float:right; margin-top:1px">
							<a class="actionlink" target="blank" href="http://4ms.kz" style="color: #444444 ; font-size:11px; "><font style="margin-left:5px;font-size:11px; vertical-align:3px">Workflow документооборот © 2012</font></a>  
						</div>
					</div>
				</div>
