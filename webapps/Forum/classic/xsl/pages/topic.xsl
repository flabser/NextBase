	    								...
	    								<td style="width:40%; padding-left:13px">
	    									<xsl:if test="$actionbar/action[@id ='NEW_GLOSSARY']/@mode= 'ON'">						
												<button title="{$actionbar/action[@id ='NEW_GLOSSARY']/@hint}" id="btnNewdoc" style="margin-right:5px">
													...
													<font style="font-size:12px; vertical-align:top"><xsl:value-of select="$actionbar/action[@id ='NEW_GLOSSARY']/@caption"/></font>
												</button>	
											</xsl:if>							
	       				...
	       				<xsl:choose>
	       					<xsl:when test=".[responses]">
								<a href="" style="vertical-align:top; margin-right:6px" id="a{@docid}">
									...
									<img border='0' src="/SharedResources/img/classic/1/minus1.png" id="img{@docid}"/>
								</a>
							</xsl:when>
							<xsl:otherwise>
								<a href="" style="vertical-align:top; margin-right:6px" id="a{@docid}">
									...
									<img border='0' src="/SharedResources/img/classic/1/plus1.png" id="img{@docid}"/>
								</a>
							</xsl:otherwise>
						</xsl:choose>
					</xsl:if>
