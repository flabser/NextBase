			...
			<ul style="margin:10px 0 0 0" id="topics_list">
				<xsl:for-each select="document/fields/topics/query/entry">
					<li style="list-style: none; padding:10px;">
						<a class="doclink-dotted topiclink_{@docid}" href="">
						...
						<div class="topic" style="display:none;" id="topic_{@docid}">
							<div id="headerTheme">
								<xsl:value-of select="viewcontent/viewtext"/>
							</div>
							<div id="infoTheme">Автор: <xsl:value-of select="viewcontent/viewtext2"/>, <xsl:value-of select="viewcontent/viewdate"/>
