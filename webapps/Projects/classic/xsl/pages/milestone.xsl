		    								...
		    								<td style="width:40%; padding-left:13px">
		    									<xsl:if test="$actionbar/action[@id='new_demand']/@mode = 'ON'">							
													<button title="{$actionbar/action[@id='new_demand']/@hint}" id="btnNewdoc" style="margin-right:5px">
														<!--<xsl:attribute name="href">javascript:window.location.href="<xsl:value-of select="$actionbar/action[@id='new_demand']/@url"/>";&lt;!&ndash; beforeOpenDocument()&ndash;&gt;</xsl:attribute>
														<xsl:attribute name="onclick">javascript:window.location.href="<xsl:value-of select="$actionbar/action[@id='new_demand']/@url"/>"; &lt;!&ndash;beforeOpenDocument()&ndash;&gt;</xsl:attribute>
														-->
	...
	<xsl:template match="//query/entry">
		...
		<tr title="{@viewtext}" class="{@docid}" id="{@docid}{@doctype}">
			...
			<td style="border:1px solid #ccc; min-width:160px;">								
				...
				<a href="{@url}&amp;page={/request/query/@currentpage}" title="{viewcontent/viewtext}" class="doclink">
...
<!-- 					<xsl:value-of select="viewcontent/viewtext" /> -->
	...
	<xsl:template match="entry" mode="item">
		...
		<a href="{@url}" title="{viewcontent/viewtext}" class="doclink" style="font-style:Verdana,​Arial,​Helvetica,​sans-serif; width:100%; font-size:97%; margin-left:2px">
			...
			<xsl:variable name='ecr2' select="replace($ecr1, '&#34;' ,'&quot;')"/>
			<xsl:variable name='ecr2' select="replace($ecr2, '&#92;&#92;' ,'&#92;&#92;&#92;&#92;')"/>
			<font class="font{@docid}{@doctype}" style="word-wrap:break-word">					 
				<script>
