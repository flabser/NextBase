								...
								<form action="Provider" name="frm" method="post" id="frm" enctype="application/x-www-form-urlencoded">
									<div display="block" id="property">
										...
										<table width="80%" border="0">
											<tr>
												<td width="30%" class="fc"><xsl:value-of select="document/captions/title/@caption"/> :</td>
				            					<td>
							       			...
							       			<tr>
												...
												<td>
					                                 <input type="text" name="code" size="10" class="td_editable" value="{document/fields/code}">
					                                 	<xsl:if test="$editmode != 'edit'">
															<xsl:attribute name="readonly">readonly</xsl:attribute>
															<xsl:attribute name="class">td_noteditable</xsl:attribute>
														</xsl:if>
							       			...
							       			<tr>
												<td class="fc"><xsl:value-of select="document/captions/rang/@caption"/> :</td>
												<td>
