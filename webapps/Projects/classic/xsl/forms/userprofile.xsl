...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="request">
		...
		<html>
	  		<head>
	 			<title>
	 				<xsl:value-of select="concat('Projects - ', document/fields/title, ' : ', document/fields/fullname)"/>
	 			</title>
			      	    				...
			      	    				<table width="80%" border="0" style="margin-top:8px">
						            		...
						            		<tr>
												...
												<td >
                                                    ...
                                                    <a style="vertical-align:middle;padding:5px 5px; display: inline-block;" href="#" onclick="javascript:sendTestEmail('{document/fields/userid}', 'email')">
                                                        <img src="/SharedResources/img/iconset/email_go.png" title="{document/captions/sendtestemail/@caption}"/>
                                                    </a>
												</td>
											</tr>	
						            		<tr>
