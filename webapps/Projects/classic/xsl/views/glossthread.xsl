...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="responses">
		<tr name="child" class="response{entry/@docid}" id="{entry/@docid}{@doctype}" onmouseover="javascript:elemBackground(this,'EEEEEE')" onmouseout="elemBackground(this,'FFFFFF')">
			<td/>
			<td nowrap="true" id="parentdoccell" style="padding-left:9px">
				<script>
