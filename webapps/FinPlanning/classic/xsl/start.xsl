...
<html>
	<head>
		<title>CashTracker&#xA0;-<xsl:value-of select="org"/></title>
	...
	<body onLoad="getCookie('smart')" onKeyDown="key(event)">
		...
		<br />
		<br />
		<form action="Login" method="post" id="frm" name="form" onsubmit="ourSubmit();return false;">

		<table width="100%" style="margin-top:10%;margin-bottom:25px;" border="0">
			<tr style="text-align:center">
				<td>
					<font class="sh" style="font-family:arial; font-size:40px;">FinPlanning 2014</font>
