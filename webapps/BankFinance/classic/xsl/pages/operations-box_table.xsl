...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template name="view-table">
		<xsl:choose>
			<xsl:when test="//view_content//query/entry">
				<div class="box_table oper-table">
	...
	<xsl:template match="view_content" mode="view-table-head">
		<div class="box_table-head">
			<div class="box_table-cell tcell-checkbox">
				<input type="checkbox" data-toggle="docid" class="all" />
			</div>
			<div class="box_table-cell tcell-icon"></div>
			<div class="box_table-cell tcell-cash">
			...
			<div class="box_table-cell tcell-date">
				<xsl:call-template name="sortingcell">
					<xsl:with-param name="namefield">
			...
			<div class="box_table-cell tcell-sum">
				<xsl:call-template name="sortingcell">
					<xsl:with-param name="namefield">
			...
			<div class="box_table-cell tcell-vt">
	...
	<xsl:template match="entry" mode="view-table-body">
		<div title="" data-ddbid="{@id}" class="box_table-row document {@docid} js_saldo_on_date" id="{@docid}{@doctype}">
			...
			<div class="box_table-cell tcell-icon">
