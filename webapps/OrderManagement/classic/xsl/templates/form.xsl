...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	<xsl:template name="docInfo">
		<span style="float:right; font-size:11px">
		    <xsl:if test="document/@status = 'existing'">
                <font style="font-weight:bold; margin-left:10px"><xsl:value-of select="document/captions/docauthor/@caption" />: </font>
	...
	<xsl:template name="documentheader">
		<div style="position:absolute;  top:0px; left:0px; width:100%; height:70px; border-bottom:1px solid #ADD8E6; background:url('classic/img/back.png');  z-index:2; ">
			...
			<span style="float:left; margin:25px 0 0 0px">
				<font style="font-size:1.6em; color:#404040; padding-left: 10px">OrderManagment</font>
