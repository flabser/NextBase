...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/request">
		...
		<html>
			<head>
				<title>MySupport - <xsl:value-of select="page/captions/title/@caption" /></title>
										...
										<tr title="{@viewtext}" class="{@docid}" id="{@docid}{@doctype}">
											...
											<td  style="border:1px solid #ccc; min-width:160px;">
												<a href="{@url}" class="doclink" style="margin-left:25px;">
                                                    ...
                                                    № <xsl:value-of select="viewcontent/viewtext"/> - <xsl:value-of select="viewcontent/viewtext1"/>
												</a>
											</td>
