								...
								<div class="button_panel" style="margin-top:1px">
									<div style="float:left; margin-left:3px; margin-top:2px; margin-bottom:3px">
										<xsl:if test="//action[@id='new_document']/@mode = 'ON'">
											<button style="margin-right:5px" title="{//actionbar['new_document']/@hint}" id="btnNewdoc">
										...
										<xsl:if test="//action[@id='delete_document']/@mode = 'ON'">
											<button style="margin-right:5px" title="{//action[@id='new_document']/@hint}" id="btnDeldoc">
