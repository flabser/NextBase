...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:variable name="doctype" select="request/document/captions/supplier/@caption"/>
							...
							<form action="Provider" name="frm" method="post" id="frm" enctype="application/x-www-form-urlencoded">
								<div display="block" id="property">
									...
									<table width="100%" border="0">
										...
										<tr>
											<td class="fc"><xsl:value-of select="document/captions/address/@caption"/> :</td>
									        <td>
						                       <input type="text" name="address" size="30" class="td_editable" value="{document/fields/address}" style="width:600px">
						                      		<xsl:if test="$editmode != 'edit'">
														<xsl:attribute name="readonly">readonly</xsl:attribute>
														<xsl:attribute name="class">td_noteditable</xsl:attribute>
													</xsl:if>
										...
										<tr>
									        ...
									        <td>
						                       <input type="text" name="phone" size="30" class="td_editable" value="{document/fields/phone}" style="width:600px">
						                      		<xsl:if test="$editmode != 'edit'">
														<xsl:attribute name="readonly">readonly</xsl:attribute>
														<xsl:attribute name="class">td_noteditable</xsl:attribute>
													</xsl:if>
