...
function loadstatinfo(){
	$.ajax({
		...
		datatype:"XML",
		url: "Provider",
		data: "type=handler&id=statistic",
		success: function (xml){
			$(xml).find("entries").find("entry").each(function(){
				$(".viewtable").append("<tr>" +
						"<td></td>"+
						"<td>"+$(this).find("viewtext").text()+"</td>"+
						"<td>"+$(this).find("address").text()+"</td>"+
						"<td>"+$(this).find("coordinats").text()+"</td>"+
						"<td>"+$(this).find("total").text()+"</td>"+
						"<td>"+$(this).find("unexecuted").text()+"</td>"+
						"<td>"+$(this).find("executed").text()+"</td>"+
				"</tr>")
			})
		},
