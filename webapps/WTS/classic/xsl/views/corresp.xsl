						...
						<xsl:choose>
							<xsl:when test="responses[node()]">
								<a href="" style="margin-left:3px" id="a{@categoryid}{@doctype}">
									...
									<img border='0' src="/SharedResources/img/classic/minus.gif" id="img{@categoryid}{@doctype}"/>
								</a>
							</xsl:when>
							<xsl:otherwise>
								<a href="" style="margin-left:3px" id="a{@categoryid}{@doctype}">
									...
									<img border='0' src="/SharedResources/img/classic/plus.gif" id="img{@categoryid}{@doctype}"/>
								</a>
							</xsl:otherwise>
						</xsl:choose>
