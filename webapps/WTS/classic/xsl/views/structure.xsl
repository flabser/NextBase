			...
			<xsl:choose>
        		<xsl:when test="entry[node()]">
					<a href="">
						...
						<img border='0' src="/SharedResources/img/classic/minus.gif">
				...
				<xsl:otherwise>
					<a href="">
						...
						<img border='0' src="/SharedResources/img/classic/plus.gif">
							<xsl:attribute name='id'>img<xsl:value-of select="@docid"/><xsl:value-of select="@doctype"/></xsl:attribute>
						</img>
					</a>
				</xsl:otherwise>
				...
				<tr>
					<td style="text-align:left">
						<xsl:if test="@hasresponse='true'">
							...
							<img style="margin-left:5px" src="/SharedResources/img/iconset/building_small.png"/><font class="font"  style="font-family:verdana; font-size:12px; margin-left:3px"><xsl:value-of select="@viewtext"/></font>
						</xsl:if>
						<xsl:if test="not(@hasresponse='true')">
							<img style="margin-left:17px" src="/SharedResources/img/iconset/building_small.png"/><font class="font"  style="font-family:verdana; font-size:12px; margin-left:3px"><xsl:value-of select="@viewtext"/></font>
						</xsl:if>
					</td>
				</tr>
