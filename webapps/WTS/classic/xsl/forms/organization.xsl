						...
						<div class="button_panel">
							<span style="float:left">
								...
								<xsl:if test="document/@status !='new'">
									<button class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" title="Зарегистрировать новый департамент" id="btnnewdep" style="margin-left:5px">
									...
									<button class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" title="Зарегистрировать нового сотрудника" id="btnnewemp" style="margin-left:5px">
