	...
	<xsl:template name="header-view">	
		<div id="header-view">
			<span style="float:left">
				...
				<font style="font-size:1.17em; vertical-align:27px; color:#555555"><xsl:value-of select="columns/column[@id = 'APPCAPTION']/@caption"/></font>
			</span>
			<span style="float:right; padding:5px 5px 5px 0px" >
				<a id="currentuser" target="_parent" title="{columns/column[@id = 'CURUSERPROP']/@caption}" href=" Provider?type=edit&amp;element=userprofile&amp;id=userprofile" style="text-decoration:none;color: #555555 ; font: 11px Tahoma; font-weight:bold">
