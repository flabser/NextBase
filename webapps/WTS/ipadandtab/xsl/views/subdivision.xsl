		...
		<span width='100%' id='picklistCoorder'>
			<xsl:for-each select="query/entry">
				<div style="display:block; width:100%; text-align:left" name="itemStruct">
					...
					<input type="checkbox" name="chbox" id="{@docid}" value="{name}" style="width:22px ; height:22px"/>
					<font class="font"  style="font-family:verdana; font-size:14px; margin-left:8px; vertical-align:4px">
