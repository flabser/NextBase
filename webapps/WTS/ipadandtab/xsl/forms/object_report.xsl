							...
							<span style=" vertical-align:12px; float:left">
								...
								<xsl:if test="document/@editmode ='edit'">
									<button class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" title="{document/actions/action [.='SAVE']/@hint}">
										<xsl:attribute name="onclick">javascript:fillingReport("project_report")</xsl:attribute>
										<span >
							...
							<form action="Provider" name="frm" method="post" id="frm" enctype="application/x-www-form-urlencoded">
								<div class="ui-tabs-panel" id="tabs-1">
									...
									<table width="100%" border="0">
										<!-- 
										<tr>
											<td class="fc">Объект :</td>
											<td>
												<xsl:variable name="object" select="document/fields/object/@attrval"/>
												<select size="1" name="object" style="background:#fff; padding:3px 3px 3px 5px; width:288px; border:1px solid #ccc">
													<xsl:if test="document/@editmode != 'edit'">
										...
										Вид работ 
										<tr>
											<td class="fc">Вид работ :</td>
											<td>
												<xsl:variable name="docscat" select="document/fields/docscat/@attrval"/>
												<select size="1" name="docscat" style="background:#fff; padding:3px 3px 3px 5px; width:288px; border:1px solid #ccc">
													<xsl:if test="document/@editmode != 'edit'">
														<xsl:attribute name="style">background:none; padding:3px 3px 3px 5px; width:288px; border:1px solid #ccc</xsl:attribute>
														<xsl:attribute name="disabled"></xsl:attribute>
													</xsl:if>
								...
								<input type="hidden" name="id" value="object_report"/>
